...
| **Tender BOM** | Bóc BOM khối lượng vách/trần, Auto-tracing biên dạng, Link-line, Gom Group CAD block, Pick 2 điểm khoảng cách lỗ mở | 🟢 Stable (v0.2.10) |
...
- Baseline deploy on dinh moi nhat: `v0.2.10`.
