...
| **Tender BOM** | Bóc BOM khối lượng vách/trần, Auto-tracing biên dạng, Link-line, Gom Group CAD block, Pick 2 điểm khoảng cách lỗ mở | 🟢 Stable (v0.2.15) |
...
- Baseline deploy ổn định mới nhất: `v0.2.15`.
