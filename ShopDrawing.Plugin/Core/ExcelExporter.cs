...
namespace ShopDrawing.Plugin.Core
{
    public class ExcelExporter
    {
        ...
        public void ExportFullBom(List<BomRow> bomRows, WasteRepository? wasteRepo, string filePath)
        {
            ...
            if (wasteRepo != null)
            {
                try { allWaste = wasteRepo.GetAll(); } catch { }
            }
            ...
            ICellStyle headerStyle, ICellStyle dataStyle, ICellStyle sumStyle, ICellStyle titleStyle)
        {
            ...
            // Headers
            string[] headers = { "STT", "MÃ TẤM", "CẤU TẠO", "RỘNG (mm)", "DÀI (mm)", "NGÀM T/P", "SỐ LƯỢNG", "DIỆN TÍCH (m²)", "TRẠNG THÁI", "TƯỜNG" };
            ...
            ICellStyle headerStyle, ICellStyle dataStyle, ICellStyle sumStyle, ICellStyle titleStyle)
        {
            ...
            // Headers
            string[] headers = { "STT", "MÃ TẤM", "CẤU TẠO", "RỘNG (mm)", "DÀI (mm)", "DIỆN TÍCH (m²)", "NGUỒN", "TRẠNG THÁI", "TƯỜNG" };
