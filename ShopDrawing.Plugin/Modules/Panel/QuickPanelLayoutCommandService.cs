...
namespace ShopDrawing.Plugin.Modules.Panel
{
    internal sealed class QuickPanelLayoutCommandService
    {
        ...
        {
            var options = new PromptEntityOptions($"\nClick Polyline biên {GetBoundaryLabel(scope)}:");
            ...
            LayoutResult layout)
        {
            ...
            foreach (var panel in allPanels)
            {
                ...
                var stepWaste = new WastePanel
                {
                    ...
                    JointLeft = panel.StepWasteSide == StepSide.Left ? panel.JointLeft : JointType.Cut,
                    JointRight = panel.StepWasteSide == StepSide.Right ? panel.JointRight : JointType.Cut,
